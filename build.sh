...
javac -source 1.8 -target 1.8    -sourcepath src -d bin -cp bin/ src/main/java/**/**.java  -cp bin/ src/main/java/**/**/**.java -cp bin/ src/main/java/**.java -cp "src/dependencies/gson-2.8.6.jar"
